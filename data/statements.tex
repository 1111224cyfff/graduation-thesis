...
\begingroup
  \parindent0pt
  \hspace*{7.5cm} 学位论文作者签名： \relax\hspace*{1cm}\\[3pt]
  \hspace*{7.5cm} 日期： \hspace{1em} 年 \hspace{1.5em} 月 \hspace{1.5em} 日 \relax\hspace*{1cm}
\endgroup
...
\begingroup
  ...
  \begin{table}[h] \begin{flushleft}
    \begin{tabular}{ll} 
      \zihao{4} 学位论文作者签名： &
      \zihao{4} \qquad 指导教师签名： \\[3pt]
      \zihao{4} 日期： \hspace{1em} 年 \hspace{1.5em} 月 \hspace{1.5em} 日 &
      \zihao{4} \qquad{}日期： \hspace{1em} 年 \hspace{1.5em} 月 \hspace{1.5em} 日 \\
    \end{tabular}
