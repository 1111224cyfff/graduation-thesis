...
\usepackage{float}
\addbibresource{ref/thesis.references.bib}             % 使用现有文献库 (根目录 ref/)
...
% 最好使用 pdf 格式的图片
% 优先使用自动裁边后的 PDF 目录，找不到时回退到原始目录
\graphicspath{{figures-cropped/}{figures/}}
...
\tongjiinputfile{data/chap06}
\tongjiinputfile{data/chap07}
